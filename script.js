...
function changeToNight(){
    if(document.getElementById("orb").className == "sun"){
        //change to moon document.getElementById("sky").className = "night";
    ...
    document.getElementById("moonspot 3").className = "visible";
    }
        ...
        document.getElementById("moonspot 3").className = "";
    }
